      ...
      <div className="container-editorial relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <h1 className="font-display font-bold text-ink-900 mb-6 leading-[1.1] tracking-tight animate-fade-up" style={{ fontSize: 'clamp(3rem, 5vw, 4.5rem)' }}>
            We don't build software.<br/>We engineer <span className="text-indigo-600">unfair advantages.</span>
          </h1>

          {/* Subtitle */}
          <p className="body-xl text-ink-500 max-w-2xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: '100ms' }}>
            Launch AI Pilot was founded with a singular mission: to rescue enterprise companies and ambitious startups from the bloated, slow, and opaque world of traditional software outsourcing.
          </p>
