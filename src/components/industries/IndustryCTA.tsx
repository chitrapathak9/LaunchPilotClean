    ...
    <section className="section-lg bg-gray-50 border-y border-gray-100 relative overflow-hidden">
      ...
      <div className="container-editorial relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cobalt-100/50 border border-cobalt-200 text-cobalt-700 text-[0.75rem] font-bold tracking-widest uppercase mb-8">
            <ShieldCheck size={14} /> Partner With Experts
          </div>

          <h2 className="heading-display text-ink-900 mb-6">
            Stop letting generic software hold back your <span className="text-cobalt-600">{industry.name}</span> operations.
          </h2>
          
          <p className="body-xl text-ink-500 mb-12 max-w-2xl mx-auto">
            We don't need 3 months of discovery to understand your business model. Let's map out a scalable, high-performance architecture tailored exactly to your domain in a single call.
          </p>
